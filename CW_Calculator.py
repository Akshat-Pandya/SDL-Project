...
def calculate_cw(attendance_score, lab_attendance_score, assignment_score, quiz_score, weights):
...
def main():
    ...
    for index, row in df.iterrows():
        ...
        final_cw = calculate_cw(attendance_score, lab_attendance_score, assignment_score, quiz_score, weights)
    ...
    print("\nResults:")
    print(f"{'Name':<25} {'Roll No':<15} {'Classes Attended (%)':<20} {'Labs Attended (%)':<20} {'Assignment Marks Obtained (%)':<30} {'Quiz Marks Obtained (%)':<25} {'CW':<10}")
    print("="*150)
    for result in results:
        print(f"{result['Name']:<25} {result['Roll No']:<15} {result['Classes Attended (%)']:<20} {result['Labs Attended (%)']:<20} {result['Assignment Marks Obtained (%)']:<30} {result['Quiz Marks Obtained (%)']:<25} {result['CW']:<10}")
